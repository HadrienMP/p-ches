	...
	function (msg, model) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					sixteenth: A2($elm$core$Basics$modBy, 16, model.sixteenth) + 1
				}),
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Main$subdivisions = A2(
	$elm$core$List$map,
	function (a) {
		return {
			label: (A2($elm$core$Basics$modBy, 4, a) === 1) ? $elm$core$String$fromInt(1 + ((a / 4) | 0)) : '',
			sixteenth: a
		};
	},
...
var $author$project$Main$title = A2(
	...
	_List_fromArray(
		[
			...
			{description: 'peach', src: '/img/peach.png'}),
			A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'background-color', '#4158D0')),
				$mdgriffith$elm_ui$Element$htmlAttribute(
				A2($elm$html$Html$Attributes$style, 'background-image', 'linear-gradient(43deg, #4158D0 0%, #C850C0 46%, #FFCC70 100%)')),
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Tick":["Time.Posix"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));